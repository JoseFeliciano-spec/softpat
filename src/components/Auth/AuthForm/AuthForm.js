              ...
              <div className="row">
                <div className="col-12">
                  <h1 className="text-center mb-3">
                    <Typewriter
                      options={{
                        strings: ['Black Friday', 'Bienvenidos a SoftPat', 'SoftPat Es Seguro', 'SoftPat Es Confiable', 'Descuento del 20%', 'Gracias Profe Mario', 'Gracias Profe Victor', 'Gracias Profe Cristian'],
                        autoStart: true,
                        loop: true,
                      }}
                    />
